            ...
            switch (choice) {
                case 1:
                    ...
                    if (count == n) {
                        ...
                        count++;
                        // total = s[i].calculateTotalMarks(assignmentOneMarks[i],
                        // assignmentTwomarks[i], projectMarks[i]);
                ...
                case 2:
                    if (count == 0) {
                        ...
                        for (int i = 0; i < count; i++) {
                            System.out.printf(
                                    "\n Student Name: %s \t Student ID: %s \t AssignmentOne Marks: %f \t AssignmentTwo Marks: %f \t Project Marks: %f \t Total Marks: %f \t Grade: %s",
                                    s[i].getStudentName(), s[i].getStudentID(), s[i].getAssignmentOneMarks(),
                                    s[i].getAssignmentTwoMarks(), s[i].getProjectMarks(),
                                    s[i].getIndividualTotalMarks(), s[i].getGrade());
                        }
                    }
                    break;
                ...
                case 3:
                    ...
                    if (count == 0) {
                        ...
                        System.out.printf(
                                ...
                                s[max].getStudentName(), s[max].getStudentID(), s[max].getIndividualTotalMarks());
                        System.out.printf(
                                "\n The student %s with student number %s has received minimum marks which is %f",
                                s[min].getStudentName(), s[min].getStudentID(), s[min].getIndividualTotalMarks());
